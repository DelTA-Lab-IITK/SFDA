...
function mnist.loadTrainSet(trainpath,maxLoad, geometry)
   return mnist.loadDataset(trainpath, maxLoad, geometry)
end

function mnist.loadTestSet(testpath,maxLoad, geometry)
   return mnist.loadDataset(testpath, maxLoad, geometry)
end
